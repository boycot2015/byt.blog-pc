        ...
        css: function css (key, val) {
            ...
            return this.forEach(function (elem) {
                ...
                if (style) {
                    ...
                    if (!resultArr.includes(currentStyle)) {
    ...
    function FontSize (editor) {
        ...
        this.droplist = new DropList(this, {
            ...
            list: [
                ...
                { $elem: $('<span style="font-size: 22px;">22px</span>'), value: '5' },
                { $elem: $('<span style="font-size: 26px;">26px</span>'), value: '6' },
                { $elem: $('<span style="font-size: 32px;">32px</span>'), value: '7' }
            ],
            onClick: function onClick (value) {
...
*/
    ...
    Panel.prototype = {
        ...
        show: function show () {
            ...
            var menu = this.menu
            if (_isCreatedPanelMenus.includes(menu)) {
